...
regEmail.addEventListener('input', () => {
    emailMsg.textContent = isValidEmail(regEmail.value) ? "✅ E-posta geçerli." : "❌ Geçerli bir e-posta girin.";
...
pass1.addEventListener('input', () => {
    pass1Msg.textContent = pass1.value.length >= 6 ? "✅ Şifre uygun." : "❌ Şifre en az 6 karakter olmalı.";
...
pass2.addEventListener('input', () => {
    pass2Msg.textContent = pass2.value === pass1.value ? "✅ Şifreler eşleşti." : "❌ Şifreler eşleşmiyor.";
...
document.getElementById('registerBtn').addEventListener('click', (e) => {
    e.preventDefault();
    if (emailMsg.textContent.includes("✅") && pass1Msg.textContent.includes("✅") && pass2Msg.textContent.includes("✅")) {
...
forgotEmail.addEventListener('input', () => {
    forgotMsg.textContent = isValidEmail(forgotEmail.value) ? "✅ E-posta uygun." : "❌ Geçerli bir e-posta girin.";
